...
# Madhusudhan Venkadesan during his work with John Guckenheimer
#
...
class Integro(object):
  ...
  def dopcor (self,n, x, y, pars, xend, hmax, h, rtoler, atoler, itoler, fileout,
    ...
    # mm debug note: pars is correct until here...
    facold = 1.0E-4
    expo1 = 0.2 - beta * 0.75
    facc1 = 1.0 / fac1
    facc2 = 1.0 / fac2
...
class odeDP5( Integro ):
  """Convenience interface to the Dopri5 integrator, allowing it to wrap a
    callable (e.g. a lambda function)
  ...
  def __call__(self,y0,t0,t1=None,dt=None):
    ...
    self.yOut = []
    self.trj = None
    self.dope( y0, tEnd = t1, dt=dt, pars=self.fpars )
